...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Seasonal and curated collections';
...
export interface ApiLookbookPostLookbookPost
  extends Struct.CollectionTypeSchema {
  collectionName: 'lookbook_posts';
  info: {
    description: 'Editorial shoots and style stories';
    displayName: 'Lookbook Post';
    pluralName: 'lookbook-posts';
    singularName: 'lookbook-post';
  };
  options: {
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    pesapalRef: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Carmu \u00C9l\u00E9gance product catalogue';
    displayName: 'Product';
    pluralName: 'products';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::lookbook-post.lookbook-post': ApiLookbookPostLookbookPost;
